...
#define aes_encryption(in, out, int_key) AES_encrypt((unsigned char*)(in), (unsigned char*)(out), (int_key))
#define aes_key_setup(key, int_key) AES_set_encrypt_key((key), VMAC_KEY_LEN, (int_key))
...
#define aes_encryption(in, out, int_key) \
  rijndaelEncrypt((u32*)(int_key), ((VMAC_KEY_LEN / 32) + 6), (u8*)(in), (u8*)(out))
#define aes_key_setup(user_key, int_key) rijndaelKeySetupEnc((u32*)(int_key), (u8*)(user_key), VMAC_KEY_LEN)
#endif
